...
#define des_val 10          // the desired ph value
#define b0=5; // lsb of the vending machine controller
#define b1=6;
#define flag1=7; // msb

#define a0=9; // lsb of the vending machine controller
#define a1=10;
#define a2=11; 
#define a3=12;// msb
...
void loop() {                           //if we see that the pH Circuit has sent a character.
  if(myserial.available() > 0){
      ...
      if(received_from_sensor >des_val){
              if (received_from_sensor ==14){
              ...
              if (received_from_sensor ==13){

                      digitalWrite(b0,LOW);
                      digitalWrite(b1,HIGH);
                      digitalWrite(flag1,HIGH);
              }
              if (received_from_sensor ==12){

                      digitalWrite(b0,HIGH);
                      digitalWrite(b1,LOW);
                      digitalWrite(flag1,HIGH);
              }
              if (received_from_sensor ==11){
